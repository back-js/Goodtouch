...
_C.PREPROCESS.UP_RATIO = 0.6 / 0.85  # delta_size / face_size #눈 주위
_C.PREPROCESS.DOWN_RATIO = 0.2 / 0.85  # delta_size / face_size #가로범위
_C.PREPROCESS.WIDTH_RATIO = 0.2 / 0.85  # delta_size / face_size
_C.PREPROCESS.LIP_CLASS = [7, 9] # 10넘을시 립 조절
